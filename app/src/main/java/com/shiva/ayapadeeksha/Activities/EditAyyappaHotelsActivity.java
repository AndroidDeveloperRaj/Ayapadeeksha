...
public class EditAyyappaHotelsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_ayyappa_hotels);
    ...
    private void getAyyappaSwamyDetails(String strMusicalBandEmail) {
        if (AppUtils.isOnline(EditAyyappaHotelsActivity.this)) {
            AppUtils.getAyyappaSwamyDetails(AppUrls.EDIT_AYYAPPA_HOTELS_DETAILS_URL, EditAyyappaHotelsActivity.this,
                        ...
                        public void onSuccess(String result) {
                            try {
                                ...
                                if (!response.getBoolean("error")) {
                                    ...
                                    Toast.makeText(EditAyyappaHotelsActivity.this, response.getString("message"), Toast.LENGTH_LONG).show();
                                }
            ...
            AppUtils.showSnackBar(EditAyyappaHotelsActivity.this);
        }
    }
    ...
    private void openAddressDialog(final String strTitle) {
        final android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(EditAyyappaHotelsActivity.this);
    ...
    private void getStates(String strStatesUrl) {
        if (AppUtils.isOnline(EditAyyappaHotelsActivity.this)) {
            ...
            AppUtils.getStates(strStatesUrl, EditAyyappaHotelsActivity.this, progressBarDialog, new VolleyCallback() {
                @Override
                public void onSuccess(String result) {
                    try {
                        JSONObject response = new JSONObject(result);
                        if (!response.getBoolean("error")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                statesAdapter = new StatesAdapter(EditAyyappaHotelsActivity.this, statesArrayList);
    ...
    private void getCities(String citiesListUrl) {
        if (AppUtils.isOnline(EditAyyappaHotelsActivity.this)) {
            ...
            AppUtils.getCities(citiesListUrl, EditAyyappaHotelsActivity.this, progressBar, strStateId, new VolleyCallback() {
                @Override
                public void onSuccess(String result) {
                    try {
                        JSONObject response = new JSONObject(result);
                        if (!response.getBoolean("error")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                citiesAdapter = new CitiesAdapter(EditAyyappaHotelsActivity.this, citiesArrayList);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!jsonObject.getBoolean("error")) {
                    Toast.makeText(EditAyyappaHotelsActivity.this, jsonObject.getString("message"), Toast.LENGTH_LONG).show();
                    ...
                    new UpdateAdapter(EditAyyappaHotelsActivity.this).execute();
                    finish();
