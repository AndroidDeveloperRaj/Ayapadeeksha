...
public class MandapVendorsActivity extends AppCompatActivity {
    private Toolbar toolbar;
    private String strMandapVendorsId, strGuMandapVendorsEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mandap_vendors);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MandapVendorsActivity.this, RegistrationActivity.class);
    ...
    protected void onResume() {
        ...
        strGuMandapVendorsEmail = getIntent().getStringExtra("MANDAP_VENDORS_EMAIL");
        init();
        tieEmail.setText(strGuMandapVendorsEmail);
    ...
    private void saveMandapVendorsDetails() {
        if (AppUtils.isOnline(MandapVendorsActivity.this)) {
            AppUtils.saveMandapVendorsDetails(AppUrls.MANDAP_VENDOR_DETAILS_URL,
                    progressBar, MandapVendorsActivity.this,
                    strEmail, strMandapVendorName, strPrice, new VolleyCallback() {
                        @Override
                        public void onSuccess(String result) {
                            try {
                                ...
                                switch (response.getString("error")) {
                                    case "false":
                                        Toast.makeText(MandapVendorsActivity.this,
        ...
        } else AppUtils.showSnackBar(MandapVendorsActivity.this);
    }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!jsonObject.getBoolean("error")) {
                    Toast.makeText(MandapVendorsActivity.this, jsonObject.getString("message"), Toast.LENGTH_LONG).show();
