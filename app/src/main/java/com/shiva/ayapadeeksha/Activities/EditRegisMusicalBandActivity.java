...
public class EditRegisMusicalBandActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_regis_musical_band);
    ...
    private void getMusicalBandDetails(String strMusicalBandEmail) {
        if (AppUtils.isOnline(EditRegisMusicalBandActivity.this)) {
            AppUtils.getMusicalBandDetails(AppUrls.EDIT_MUSICAL_BAND_DETAILS_URL, EditRegisMusicalBandActivity.this,
                        ...
                        public void onSuccess(String result) {
                            try {
                                ...
                                if (!response.getBoolean("error")) {
                                    ...
                                    Toast.makeText(EditRegisMusicalBandActivity.this, response.getString("message"), Toast.LENGTH_LONG).show();
                                }
            ...
            AppUtils.showSnackBar(EditRegisMusicalBandActivity.this);
        }
    }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!jsonObject.getBoolean("error")) {
                    Toast.makeText(EditRegisMusicalBandActivity.this, jsonObject.getString("message"), Toast.LENGTH_LONG).show();
