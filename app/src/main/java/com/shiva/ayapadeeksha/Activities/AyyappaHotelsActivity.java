...
public class AyyappaHotelsActivity extends AppCompatActivity implements View.OnClickListener {
    private Toolbar toolbar;
    private String strAyyappaHotelsId, strAyyappaHotelsEmail, strCityId, strStateId;
    private Button btnSave, btnCancel, btnHeaderName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ayyappa_hotels);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AyyappaHotelsActivity.this, RegistrationActivity.class);
    ...
    private void saveAyyappaHotelsDetails() {
        if (AppUtils.isOnline(AyyappaHotelsActivity.this)) {
            AppUtils.saveAyyappaHotelsDetails(AppUrls.AYYAPPA_SWAMY_HOTELS_DETAILS_URL,
                    progressBar, AyyappaHotelsActivity.this,
                    strEmail, strAyyappaHotelName, strFlatNo, strLocality, strLandMark,
                    strState, strCity, strPinCode, strPrice, new VolleyCallback() {
                        @Override
                        public void onSuccess(String result) {
                            try {
                                ...
                                switch (response.getString("error")) {
                                    case "false":
                                        Toast.makeText(AyyappaHotelsActivity.this,
        ...
        } else AppUtils.showSnackBar(AyyappaHotelsActivity.this);
    }
    ...
    private void openAddressDialog(final String strTitle) {
        final android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(AyyappaHotelsActivity.this);
    ...
    private void getStates(String strStatesUrl) {
        if (AppUtils.isOnline(AyyappaHotelsActivity.this)) {
            ...
            AppUtils.getStates(strStatesUrl, AyyappaHotelsActivity.this, progressBarDialog, new VolleyCallback() {
                @Override
                public void onSuccess(String result) {
                    try {
                        JSONObject response = new JSONObject(result);
                        if (!response.getBoolean("error")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                statesAdapter = new StatesAdapter(AyyappaHotelsActivity.this, statesArrayList);
            ...
            AppUtils.showSnackBar(AyyappaHotelsActivity.this);
        }
    }
    ...
    private void getCities(String citiesListUrl) {
        if (AppUtils.isOnline(AyyappaHotelsActivity.this)) {
            ...
            AppUtils.getCities(citiesListUrl, AyyappaHotelsActivity.this, progressBar, strStateId, new VolleyCallback() {
                @Override
                public void onSuccess(String result) {
                    try {
                        JSONObject response = new JSONObject(result);
                        if (!response.getBoolean("error")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                citiesAdapter = new CitiesAdapter(AyyappaHotelsActivity.this, citiesArrayList);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!jsonObject.getBoolean("error")) {
                    Toast.makeText(AyyappaHotelsActivity.this, jsonObject.getString("message"), Toast.LENGTH_LONG).show();
