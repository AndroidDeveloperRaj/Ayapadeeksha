...
public class EditGuruSwamyActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_guru_swamy);
    ...
    private void getGuruSwamyDetails(String strGuruSwamyEmail) {
        if (AppUtils.isOnline(EditGuruSwamyActivity.this)) {
            AppUtils.getGuruSwamyDetails(AppUrls.EDIT_GURU_SWAMY_DETAILS_URL, EditGuruSwamyActivity.this,
                        ...
                        public void onSuccess(String result) {
                            try {
                                ...
                                if (!response.getBoolean("error")) {
                                    ...
                                    Toast.makeText(EditGuruSwamyActivity.this, response.getString("message"), Toast.LENGTH_LONG).show();
                                }
            ...
            AppUtils.showSnackBar(EditGuruSwamyActivity.this);
        }
    }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!jsonObject.getBoolean("error")) {
                    Toast.makeText(EditGuruSwamyActivity.this, jsonObject.getString("message"), Toast.LENGTH_LONG).show();

                    AppConstants.VENDORS_ID = strGuruSwamyId;
                    ...
                    new UpdateAdapter(EditGuruSwamyActivity.this).execute();
                    finish();
