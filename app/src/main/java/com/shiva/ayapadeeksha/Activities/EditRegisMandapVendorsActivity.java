...
public class EditRegisMandapVendorsActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_regis_mandap_vendors);
    ...
    private void getMandapVendorsDetails(String strMandapVendorsEmail) {
        if (AppUtils.isOnline(EditRegisMandapVendorsActivity.this)) {
            AppUtils.getMandapVendorsDetails(AppUrls.EDIT_MANDAP_VENDORS_DETAILS_URL, EditRegisMandapVendorsActivity.this,
                        ...
                        public void onSuccess(String result) {
                            try {
                                ...
                                if (!response.getBoolean("error")) {
                                    ...
                                    Toast.makeText(EditRegisMandapVendorsActivity.this, response.getString("message"), Toast.LENGTH_LONG).show();
                                }
            ...
            AppUtils.showSnackBar(EditRegisMandapVendorsActivity.this);
        }
    }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!jsonObject.getBoolean("error")) {
                    Toast.makeText(EditRegisMandapVendorsActivity.this, jsonObject.getString("message"), Toast.LENGTH_LONG).show();
